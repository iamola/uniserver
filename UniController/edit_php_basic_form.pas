...
If UENV_PHP_SELECT ='php56' then
 begin
  USF_PHP_INI      := USF_PHP_INI_TEST_56; // config php_test.ini
  USF_PHP_INI_DEV  := USF_PHP_INI_DEV_56;  // config php_development.ini
  USF_PHP_INI_PROD := USF_PHP_INI_PROD_56; // php_production.ini
 end;
//--End PHP 56  selected
